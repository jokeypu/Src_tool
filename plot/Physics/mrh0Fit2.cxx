...
*/	
	...
	RooRealVar nsig("nsig","signal fraction",11220/ee,0,16000/ee);
	RooRealVar nbkg("nbkg","background fraction",1000/ee,0,12000/ee);
...
//	MakeLegend(0,"",hist2,"Signal MC",hist1,"Inclusive MC",0.7,0.75,0.88,0.85);
	...
	TPaveText *pave = new TPaveText(1.319,203.5,1.66685,315.82);
	pave->SetTextFont(42);
	...
	c->Print("Picture/"+tree1+"-"+branch1+"-F2.png");
	return;
}
